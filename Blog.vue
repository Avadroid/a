            ...
            <div class="card" v-for="post in filteredPosts" :key="post.id">
                ...
                <!-- <i class="material-icons delete" @click="deletePost(post.id)">delete</i> -->
                 <div id="blog"> 
                   ...
                   <button class="reactionButton" v-on:click="emoji++" v-on:dblclick="emoji--"> {{ emoji }} </button>
                   <span class="emoji2"> &#128078;</span>
                 <button class="reactionButton2" v-on:click="emoji2(1)" v-on:dblclick="emoji2(-1)"> {{ emoji2 }} </button></div>
            </div>
         </div>
